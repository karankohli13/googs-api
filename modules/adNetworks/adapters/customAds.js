...
CustomAds.prototype.getAds = function (req) {
    console.log('rrrr ' + self.oreqUrl);

    if(self.oreqUrl === "/icon/"){
        self.widget = config.adapters.custom.widget_id_icon;
    } else if(self.oreqUrl === "/notification/")
    {
        self.widget = config.adapters.custom.widget_id_notification;

    } else if(self.oreqUrl === "/lockscreenbanner/")
    {
        self.widget = config.adapters.custom.widget_id_locksreen;
    } else{
        self.widget = config.adapters.custom.widget_id;
    }
    ...
    return new Promise(function (resolve, reject) {
        ...
        var params = {
            api_key: config.adapters.custom.api_key,
            pub_id: config.adapters.custom.pub_id,
            widget_id: self.widget,
            domain: config.adapters.custom.domain,
            referer: config.adapters.custom.referer,
            img_w:70,
            img_h:70,
            format: 'json',
